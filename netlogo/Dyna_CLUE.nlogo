...
to setup-perm-globals
  ...
  set burnt-area-class burnt-area-class-input ; TODO make widget for this selection or import from file
end
...
to style-patch
  ...
  if style-pcolor-choice = "fire-pron" [
    set pcolor scale-color red patch-fire-pron 0 1
  ]
  style-plabel
end
...
style-pcolor-choice
style-pcolor-choice
"class" "class-optimal" "class-iter" "class-suit" "fire-pron"
0
...
<experiments>
  <experiment name="experiment" repetitions="1" runMetricsEveryStep="true">
    ...
    <enumeratedValueSet variable="class-allocation-switch">
      <value value="true"/>
    </enumeratedValueSet>
    <enumeratedValueSet variable="input-world-height">
      <value value="355"/>
    </enumeratedValueSet>
    <enumeratedValueSet variable="iter-slider">
      <value value="3200"/>
    </enumeratedValueSet>
    <enumeratedValueSet variable="succession-switch">
      <value value="false"/>
    </enumeratedValueSet>
    <enumeratedValueSet variable="functional-group">
      <value value="&quot;grassland&quot;"/>
    </enumeratedValueSet>
    <enumeratedValueSet variable="plabel-switch">
      <value value="false"/>
    </enumeratedValueSet>
    <enumeratedValueSet variable="globals-data-file">
      <value value="&quot;../data/sabor_globals.csv&quot;"/>
    </enumeratedValueSet>
    <enumeratedValueSet variable="fire-choice">
      <value value="&quot;no fire&quot;"/>
    </enumeratedValueSet>
    <enumeratedValueSet variable="input-world-width">
      <value value="403"/>
    </enumeratedValueSet>
    <enumeratedValueSet variable="patches-data-file">
      <value value="&quot;../data/sabor_patches.csv&quot;"/>
    </enumeratedValueSet>
    <enumeratedValueSet variable="ignitions">
      <value value="13"/>
    </enumeratedValueSet>
    <enumeratedValueSet variable="class-suit-choice">
      <value value="17"/>
    </enumeratedValueSet>
    <enumeratedValueSet variable="style-pcolor-choice">
      <value value="&quot;class-suit&quot;"/>
    </enumeratedValueSet>
    <enumeratedValueSet variable="update-allocation-plots-switch">
      <value value="true"/>
    </enumeratedValueSet>
    <enumeratedValueSet variable="stop-allocation">
      <value value="false"/>
    </enumeratedValueSet>
    <enumeratedValueSet variable="comp-adv-step-size">
      <value value="0.01"/>
    </enumeratedValueSet>
  </experiment>
</experiments>
